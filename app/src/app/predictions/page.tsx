...
export default function PredictionsPage() {
  ...
  return (
    <div className="relative h-[calc(100vh-3.5rem)] w-full overflow-hidden bg-transparent">
      {/* Search overlay */}
      {showSearch && (
        <div className="absolute inset-x-0 top-0 z-30 bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 border-b border-white/10 animate-slide-down">
          <div className="p-4">
      ...
      {/* Top controls */}
      <div className="absolute left-0 right-0 top-0 z-20 flex items-center gap-2 px-3 py-3">
      ...
      {!loading && filteredMarkets.length === 0 && (
        <div className="flex h-full flex-col items-center justify-center text-white/40">
          ...
          <Link href="/" className="mt-4 rounded-full bg-primary-500 px-6 py-2 text-sm font-bold text-white transition-all hover:bg-primary-400">
            Back to Markets
          </Link>
        </div>
      )}
