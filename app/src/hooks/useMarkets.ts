...
function getDemoMarkets(): Market[] {
  ...
  return [
    ...
    withCryptoDefaults({
      ...
      description: "Will Bitcoin price go up or down from $84,750 within 15 minutes? Resolved automatically via Pyth Network oracle.",
    ...
    withCryptoDefaults({
      ...
      description: "Will Ethereum exceed $2,200 within 1 hour? Current price: $2,185. Resolved automatically via Pyth Network oracle.",
    ...
    withCryptoDefaults({
      ...
      description: "Will Solana price go up or down from $128.50 within 5 minutes? Resolved automatically via Pyth Network oracle.",
    ...
    withCryptoDefaults({
      ...
      description: "Will Bitcoin exceed $85,000 within 4 hours? Current price: $84,750. Resolved automatically via Pyth Network oracle.",
      creator: "CryptoTrader111111111111111111111111111111111",
      category: "crypto",
    ...
    withCryptoDefaults({
      ...
      description: "Will Ethereum price go up or down from $2,185 within 24 hours? Resolved automatically via Pyth Network oracle.",
      creator: "CryptoTrader222222222222222222222222222222222",
      category: "crypto",
